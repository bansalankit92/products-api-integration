...
public interface CollaborationExtension extends Extension {
     ...
     */
    List genericSearchForEntitySelectorForEventDetails(List searchParams, long fetchSize,
     ...
     */
    List genericSearchForEntitySelectorForMailDetails(List searchParams, Double fetchSize,
