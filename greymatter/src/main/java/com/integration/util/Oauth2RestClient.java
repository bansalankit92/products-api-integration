...
public class Oauth2RestClient {
    ...
    public String postMultipart(String url, List<MetaRequest> meta, File file)
        ...
        MultiPart multipartEntity =
                new FormDataMultiPart().field("meta", new Gson().toJson(meta), MediaType.APPLICATION_JSON_TYPE);
        if (file != null) {
    ...
    public Map getAuthTokenResponse() throws InterruptedException, ExecutionException, IOException {
