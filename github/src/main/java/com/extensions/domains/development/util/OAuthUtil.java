...
import static com.extensions.domains.development.util.GithubUtil.*;
...
public class OAuthUtil {
    ...
    public OAuth2AccessToken getGithubTokenByRefreshToken() throws InterruptedException,
        ...
        System.out.println(GithubUtil.gson.toJson(auth2AccessToken));
    ...
    public String getAuthorizationUrl() {
        return oAuthService.getAuthorizationUrl() + "&access_type=offline&prompt=consent";
    }

    public static String get(OAuthUtil authUtil, String path, Map<String, String> queryParams)
            throws IOException, ExecutionException, InterruptedException {
        String url = OAuthUtil.GITHUB_URL + path;
    ...
    public static String post(OAuthUtil authUtil, String path, Map<String, Object> body)
        ...
        request.setPayload(GithubUtil.gson.toJson(body));
        request.addHeader("Content-Type", "application/json");
